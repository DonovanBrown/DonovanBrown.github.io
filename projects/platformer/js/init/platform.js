(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(650, 575,.35,.1);
        platform.create(25,150,.05,.05);
        platform.create(365,175,.15,.15);
        platform.create(175, 575,.75,.25);
        platform.create(0,400,1.25,.15);
        platform.create(497,180,.009,7);
        platform.create(175,400,.02,5.5)
